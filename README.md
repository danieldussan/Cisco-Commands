...
Repositorio con comandos, ejemplos y ejercicios para aprender y practicar administración de redes Cisco (enfoque CCNA).

Contenido principal:

| Archivo                                                                              | Descripción                                                   |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [`01_comandos_basicos.md`](01_comandos_basicos.md)                                   | Comandos básicos, explicaciones y ejercicios rápidos          |
...
| [`04_subnetting_y_vlan_interrouting.md`](04_subnetting_y_vlan_interrouting.md)       | Subnetting, VLSM y router-on-a-stick                          |
| [`05_dhcp_nat_dns.md`](05_dhcp_nat_dns.md)                                           | DHCP, NAT (dinámico) y PAT, DNS básico                        |
| [`06_ospf_eigrp_rip.md`](06_ospf_eigrp_rip.md)                                       | Configuración y verificación para OSPF, EIGRP y RIP           |
| [`07_acl_y_ace.md`](07_acl_y_ace.md)                                                 | ACLs estándar y extendidas, por nombre, ejemplos prácticos    |
